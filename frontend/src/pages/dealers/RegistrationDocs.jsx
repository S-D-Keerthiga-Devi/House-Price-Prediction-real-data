...
import { submitRegistrationDocs } from '../../api/dealerApi'
...
function RegistrationDocs() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await submitRegistrationDocs(formData)
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  className={`w-full px-3 py-2 border-2 rounded-lg focus:outline-none focus:ring-1 focus:ring-blue-900 focus:border-transparent text-sm ${errors.registrationType ? 'border-red-400 bg-red-50' : 'border-blue-900'
                    }`}
                >
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full px-3 py-2 border-2 rounded-lg focus:outline-none focus:ring-1 focus:ring-blue-900 focus:border-transparent text-sm ${errors.entityName ? 'border-red-400 bg-red-50' : 'border-blue-900'
                    }`}
