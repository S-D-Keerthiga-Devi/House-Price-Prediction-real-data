...
function FractionalInvestment() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // const response = await axios.post('/api/fractional-investment', formData)
      
      await new Promise(resolve => setTimeout(resolve, 1000))
      
      setSubmitStatus({
        type: 'success',
        message: 'Thank you for your interest in Fractional Investment! Our investment advisory team will review your profile and contact you within 24 hours to discuss personalized investment opportunities. For immediate assistance, please call us at +91 98765 43210.'
      })
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-700 max-w-2xl mx-auto">
            Invest in Premium Assets with Fractional Ownership
          </p>
        ...
        <div className="bg-white rounded-2xl shadow-2xl border-2 border-blue-900 overflow-hidden">
          ...
          <div className="bg-blue-900 px-8 py-6">
            ...
            <p className="text-blue-100 text-center mt-2">
              Share your investment preferences and our experts will guide you through exclusive opportunities
            </p>
          </div>
            ...
            <div className="space-y-7">
              ...
              <div>
                ...
                >
                  ...
                  <option value="office-spaces">Premium Office Spaces</option>
                  <option value="retail-spaces">Retail Spaces</option>
                  <option value="land-plots">Land Plots</option>
                  <option value="reits">REITs (Real Estate Investment Trusts)</option>
                  <option value="art-collectibles">Art & Collectibles</option>
                  <option value="startups">Startup Equity</option>
                  <option value="diverse-portfolio">Diversified Portfolio</option>
                </select>
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Tell us about your investment experience, specific preferences, questions, or any other details that will help us provide personalized recommendations..."
                ></textarea>
              </div>
              ...
              <div className="pt-4 border-t border-gray-200">
                <p className="text-xs text-gray-600 leading-relaxed">
                  <strong>Investment Disclaimer:</strong> All investments are subject to market risks. Past performance is not indicative of future returns. Please read all investment-related documents carefully before investing. The value of investments may go up or down.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mt-8 text-center space-y-3">
          ...
          <p className="text-xs text-gray-600">
            Our investment advisors are available Monday to Friday, 9:00 AM - 6:00 PM
          </p>
        </div>
      </div>
    </div>
