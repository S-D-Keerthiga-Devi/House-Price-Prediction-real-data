...
function VentureInvestments() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // const response = await axios.post('/api/venture-investment', formData)
      
      await new Promise(resolve => setTimeout(resolve, 1000))
      
      setSubmitStatus({
        type: 'success',
        message: 'Thank you for your interest in Venture Capital investments! Our venture investment team will review your profile and contact you within 24-48 hours to discuss exciting startup opportunities. For immediate assistance, please call us at +91 98765 43210.'
      })
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-700 max-w-2xl mx-auto">
            Invest in High-Growth Startups & Emerging Companies
          </p>
        ...
        <div className="bg-white rounded-2xl shadow-2xl border-2 border-blue-900 overflow-hidden">
          ...
          <div className="bg-blue-900 px-8 py-6">
            <h2 className="text-2xl font-semibold text-white text-center">
              Join Our Venture Investment Network
            </h2>
            <p className="text-blue-100 text-center mt-2">
              Share your investment preferences and get access to vetted startup opportunities
            </p>
          </div>
          ...
          <div className="p-8 sm:p-10 bg-white">
            ...
            <div className="space-y-7">
              ...
              {/* Investor Type */}
              <div>
                <label htmlFor="investorType" className="block text-sm font-semibold text-blue-900 mb-2">
                ...
                <select
                  ...
                  onChange={handleChange}
                  className={`w-full px-4 py-3 border-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-900 focus:border-transparent transition-all ${
                    errors.investorType ? 'border-red-400 bg-red-50' : 'border-blue-900 hover:border-blue-700'
                  }`}
                >
                  ...
                  <option value="first-time-investor">First-time VC Investor</option>
                </select>
                {errors.investorType && (
                  <p className="mt-2 text-sm text-red-600 flex items-center">
                    <svg className="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="diversified">Diversified (All Sectors)</option>
                  </select>
                </div>
              </div>

              {/* Stage Preference and Investment Experience */}
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label htmlFor="stagePreference" className="block text-sm font-semibold text-blue-900 mb-2">
                  ...
                  >
                    ...
                    <option value="series-c-plus">Series C & Beyond</option>
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="1-3-deals">1-3 Previous Deals</option>
                    <option value="4-10-deals">4-10 Previous Deals</option>
                    <option value="10-plus-deals">10+ Previous Deals</option>
                    <option value="professional-vc">Professional VC/PE</option>
                  </select>
                </div>
              </div>

              {/* Risk Appetite and City */}
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label htmlFor="riskAppetite" className="block text-sm font-semibold text-blue-900 mb-2">
                    Risk Appetite
                  </label>
                  <select
                    id="riskAppetite"
                  ...
                  >
                    ...
                    <option value="conservative">Conservative (Proven businesses)</option>
                    ...
                    <option value="very-aggressive">Very Aggressive (Early-stage, high risk)</option>
                  </select>
                </div>
              ...
              <div>
                <label htmlFor="additionalInfo" className="block text-sm font-semibold text-blue-900 mb-2">
                  Investment Criteria & Additional Information
                </label>
                <textarea
                  id="additionalInfo"
                  name="additionalInfo"
                  ...
                  placeholder="Tell us about your investment thesis, specific criteria, past investments, areas of expertise, or any other details that will help us match you with relevant opportunities..."
                ></textarea>
              </div>
              ...
              <div className="pt-4 border-t border-gray-200">
                <p className="text-xs text-gray-600 leading-relaxed">
                  <strong>Venture Capital Investment Disclaimer:</strong> Venture capital investments involve substantial risk including possible loss of principal. Startups and early-stage companies have a high failure rate. Past performance is not indicative of future results. Investments are typically illiquid and may be held for extended periods. Only invest capital you can afford to lose. Please consult with financial and legal advisors before making any investment decisions.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
            <div className="flex items-center mb-2">
              ...
              <h3 className="font-semibold text-blue-900">High Growth Potential</h3>
            </div>
            <p className="text-sm text-gray-700">Access to early-stage high-growth companies</p>
          </div>
          ...
          <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
            <div className="flex items-center mb-2">
              ...
              <h3 className="font-semibold text-blue-900">Vetted Deals</h3>
            </div>
            <p className="text-sm text-gray-700">Curated opportunities with due diligence</p>
          </div>
          ...
          <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
            <div className="flex items-center mb-2">
              ...
              <h3 className="font-semibold text-blue-900">Network Access</h3>
            </div>
            <p className="text-sm text-gray-700">Join a community of like-minded investors</p>
          </div>
        </div>
        ...
        <div className="mt-8 text-center space-y-2">
          ...
          <p className="text-xs text-gray-600">
            Our venture investment advisors are available Monday to Friday, 10:00 AM - 6:00 PM
          </p>
          <div className="mt-4 pt-4 border-t border-gray-200">
            <p className="text-xs text-gray-500">
              Investment in startups and venture capital are subject to high risk and market uncertainties. Consult with financial advisors before making investment decisions.
            </p>
          </div>
        </div>
      </div>
